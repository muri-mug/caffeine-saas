...
const translations = {
  pt: {
    ...
    dashboard: {
      ...
      costCoverageWarning: 'CMV incompleto: {pct} da receita é de itens sem custo cadastrado no Loyverse',
  ...
  en: {
    ...
    dashboard: {
      ...
      costCoverageWarning: 'Incomplete COGS: {pct} of revenue is from items with no cost set up in Loyverse',
